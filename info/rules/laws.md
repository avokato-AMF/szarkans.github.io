...
- `11.1.1` Пометкой территории можно считать то, что визуально обозначено по всему периметру территории котика - забор, столбы, яркие ковры, таблички (если идут в ряд), **кроме факелов**. В ряд - это интервалы максимум 5 блоков.
